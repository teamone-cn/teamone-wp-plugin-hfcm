                    ...
                    <form method="post">
                        <p>
                            <?php _e(
                                ...
                                download button to export to a .json file which you can then import to another TeamoneHFCM
                        ...
                        <p class="hfcm-submit">
                            <button type="submit" name="action" class="button button-primary" value="team_one_download">
            ...
            <div id="hfcm-admin-tool-import" class="postbox ">
                ...
                <div class="inside">
                    <form method="post" enctype="multipart/form-data">
                        <p>
                            <?php _e(
                                'Select the TeamoneHFCM JSON file you would like to import. When you click the import button below,
                                TeamoneHFCM will import the field groups.', 'header-footer-code-manager'
                            ); ?>
                        </p>
                        <div class="hfcm-fields">
                                    ...
                                    <div class="hfcm-file-uploader" data-library="all" data-mime_types=""
                                        ...
                                        <div class="hide-if-value">
                                            <label class="hfcm-basic-uploader">
                                                <input type="file" name="team_one_nnr_hfcm_import_file"
                                                       id="team_one_nnr_hfcm_import_file">
                                            </label>
                                        </div>
                                    </div>
                                </div>
